...
const Services = () => {
  return(
    <div className="d-flex flex-wrap justify-content-center">
      ...
      <div id="services" className="container row row-cols-1 row-cols-md-2 row-cols-lg-3 text-center gy-4 mb-4">
        
        <Card iconCode="text-primary fa-solid fa-desktop py-5" title="UX Design" 
        ...
        <Card iconCode="text-primary fa-solid fa-code py-5" title="Développement web" 
        ...
        <Card iconCode="text-primary fa-solid fa-magnifying-glass py-5" title="Référencement" 
